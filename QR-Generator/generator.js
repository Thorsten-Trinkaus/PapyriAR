...
/**
 * @typedef {boolean} markerReady - Flag indicating if the marker images 
...
/**
 * @typedef {string} qrUrl - The full URL of the QR-Code 
 * (`baseUrl` + URL extension).
 */
let qrUrl = "";

/**
 * @typedef {boolean} downloadReady - Flag indicating if the `qrIm` image is 
...
function generateWithXML() {
    ...
    if (xmlIn.files.length > 0) {
        ...
        reader.onload = function () {
            ...
            // maxWidth and maxHeight from the XML file.
            ...
            // Get all text lines and compute the needed information 
            // for each line and update the url.
