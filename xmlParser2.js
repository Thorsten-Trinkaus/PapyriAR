...
function constructURL(directory, identifier) {
    const baseURL = "https://raw.githubusercontent.com/papyri/idp.data/master/HGV_meta_EpiDoc";
    const filePath = `HGV${directory}/${identifier}.xml`;
...
// Example usage
const directory = "1"; // Adjust directory as necessary
const identifier = "10"; // Adjust identifier as necessary
