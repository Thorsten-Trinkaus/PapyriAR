...
rl.question('Enter the identifier: ', async (identifier) => {
    try {
        const result = await fetchAndParseXMLs(identifier);
        console.log('Metadata ID:', result.metadataId);
        console.log('Transcription ID:', result.transcriptionId);
        console.log('Title:', result.metadata.title || 'N/A');
        console.log('Material:', result.metadata.material || 'N/A');
        console.log('Original Place:', result.metadata.originalPlace || 'N/A');
        console.log('Original Date:', result.metadata.originalDate || 'N/A');
        console.log('Subjects:', result.metadata.subjects.length ? result.metadata.subjects.join(', ') : 'N/A');
